...
print("=" * 70)
print("DEMARRAGE DES TESTS AUTOMATIQUES - MLP")
print("=" * 70)
print(f"Date : {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
print(f"Nombre de configurations : {len(configs)}")
print(f"Temps estime : environ {len(configs) * 3} minutes")
print("=" * 70)
print()

log_file = "mlp_results_log.txt"
with open(log_file, "w", encoding="utf-8") as f:
    f.write("# LOG DES RESULTATS MLP\n")
...
for i, config in enumerate(configs, 1):
    ...
    exit_code = os.system("python mnist_mlp.py")
